import random
from CybORG_plus.Debugged_CybORG.CybORG.CybORG.Shared.Actions import DiscoverRemoteSystems, DiscoverNetworkServices, ExploitRemoteService, PrivilegeEscalate, Impact
