...
from CybORG_plus.Debugged_CybORG.CybORG.CybORG.Shared.Actions.MSFActionsFolder.MSFAction import MSFAction, lo

# Upgrade a MSF_SHELL session to a METERPRETER session
from CybORG_plus.Debugged_CybORG.CybORG.CybORG.Shared.Enums import SessionType, AppProtocol
