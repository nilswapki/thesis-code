...
from CybORG_plus.Debugged_CybORG.CybORG.CybORG.Shared.Actions.ShellActionsFolder.CredentialHarvestingFolder.CredentialHarvesting import CredentialHarvesting
from CybORG_plus.Debugged_CybORG.CybORG.CybORG.Shared.Enums import OperatingSystemType, Path
